...
contract CrossChainTest is Test {
    ...
    function setUp() public {
        ...
        TokenAdminRegistry(sepoliaNetworkDetails.tokenAdminRegistryAddress).setPool(address(sepoliaToken), sepoliaPool);
        vm.stopPrank();
        ...
        TokenAdminRegistry(arbSepoliaNetworkDetails.tokenAdminRegistryAddress)
            .setPool(address(arbSepoliaToken), arbSepoliaPool);
        configureTokenPool(
            sepoliaFork,
            address(sepoliaPool),
