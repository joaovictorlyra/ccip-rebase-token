...
import {IERC20} from "@ccip/contracts/src/v0.8/ccip/vendor/openzeppelin-solidity/v5.0.2/contracts/token/ERC20/IERC20.sol";
...
contract RebaseTokenPool is TokenPool {
    ...
    function lockOrBurn(Pool.LockOrBurnInV1 calldata lockOrBurnIn) 
        external returns (Pool.LockOrBurnOutV1 memory lockOrBurnOut) 
        {
            ...
            lockOrBurnOut = Pool.LockOrBurnOutV1({
                ...
                destPoolDate: abi.encode(userInterestRate);
            });
        }
    ...
    {
        _valideateReleaseOrMint(releaseOrMintIn);
